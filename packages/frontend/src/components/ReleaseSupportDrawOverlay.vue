    ...
    <div v-if="open" class="rs-draw-overlay rs-ignore-capture" :class="{ 'rs-draw-overlay--dark': darkMode }">
      ...
      <div class="rs-draw-toolbar">
        ...
        <div class="rs-draw-toolbar__actions">
          ...
          <button type="button" class="rs-btn rs-btn--primary" :disabled="capturing" @click="save">
            {{ capturing ? labels.capturing : labels.save }}
          </button>
        </div>
      </div>
...
import { capturePageScreenshot, compositeCanvases } from '../utils/screenCapture'
