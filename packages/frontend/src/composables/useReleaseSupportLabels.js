...
export function useReleaseSupportLabels(languageRef) {
  ...
  const t = computed(() => {
    ...
    return {
      ...
      paginationAria: tr('widget.pagination.aria'),
      paginationPrev: tr('widget.pagination.prev'),
      paginationNext: tr('widget.pagination.next'),
      paginationPage: tr('widget.pagination.page'),
      paginationRange: tr('widget.pagination.range'),
      paginationNoMatches: tr('widget.pagination.noMatches'),
      ...
      statusCancelled: tr('widget.status.cancelled'),
      ...
      userTabReports: tr('widget.list.userTabReports'),
      userTabUpdates: tr('widget.list.userTabUpdates'),
      sectionActiveUser: tr('widget.list.sectionActiveUser'),
      sectionClosedUser: tr('widget.list.sectionClosedUser'),
      userUpdatesEmpty: tr('widget.list.userUpdatesEmpty'),
      userUpdatesRead: tr('widget.list.userUpdatesRead'),
      userUpdatesNoNotes: tr('widget.list.userUpdatesNoNotes'),
      userUpdateUntitled: tr('widget.list.userUpdateUntitled'),
      devTabReports: tr('widget.list.devTabReports'),
      devTabVersions: tr('widget.list.devTabVersions'),
      metricsOpen: tr('widget.metricsPanel.open'),
      metricsMedian: tr('widget.metricsPanel.median'),
      metricsPerDay: tr('widget.metricsPanel.perDay'),
      metricsNoData: tr('widget.metricsPanel.noData'),
      versionsPublish: tr('widget.versionsPanel.publish'),
      versionsList: tr('widget.versionsPanel.list'),
      versionsVersion: tr('widget.versionsPanel.version'),
      versionsTitle: tr('widget.versionsPanel.title'),
      versionsTitlePh: tr('widget.versionsPanel.titlePh'),
      versionsContent: tr('widget.versionsPanel.content'),
      versionsContentPh: tr('widget.versionsPanel.contentPh'),
      versionsActive: tr('widget.versionsPanel.active'),
      versionsInactive: tr('widget.versionsPanel.inactive'),
      versionsForce: tr('widget.versionsPanel.force'),
      versionsCreate: tr('widget.versionsPanel.create'),
      versionsSave: tr('widget.versionsPanel.save'),
      versionsEdit: tr('widget.versionsPanel.edit'),
      versionsEmpty: tr('widget.versionsPanel.empty'),
      versionsView: tr('widget.versionsPanel.view'),
      versionsBackToList: tr('widget.versionsPanel.backToList'),
      versionsDetailTitle: tr('widget.versionsPanel.detailTitle'),
      versionsCreateMerge: tr('widget.versionsPanel.createMerge'),
      releaseNextVersion: tr('widget.release.nextVersion'),
      releaseWaitingLabel: tr('widget.release.waitingLabel'),
      releaseMergedLabel: tr('widget.release.mergedLabel'),
      releaseWaitingHead: tr('widget.release.waitingHead'),
      releaseMergedHead: tr('widget.release.mergedHead'),
      releaseNoMerges: tr('widget.release.noMerges'),
      releaseReady: tr('widget.release.ready'),
      releaseBlockersIntro: tr('widget.release.blockersIntro'),
      releaseBlockerNoWaiting: tr('widget.release.blockerNoWaiting'),
      releaseSelectForMerge: tr('widget.release.selectForMerge'),
      releaseSelectAll: tr('widget.release.selectAll'),
      releaseSelectNone: tr('widget.release.selectNone'),
      releaseSelectedCount: tr('widget.release.selectedCount'),
      releaseSelectAtLeastOne: tr('widget.release.selectAtLeastOne'),
      releaseWaitingBadge: tr('widget.release.waitingLabel'),
      releaseWaitingTruncated: tr('widget.release.waitingTruncated'),
